<template>
	<view class="container">
		...
		<view class="introduce-section">
			<text class="title1">{{product.name}}</text><br>
			<text class="title2">{{product.subTitle}}</text>
			<view class="price-box">
				项目进度: <text class="price">{{product.price}}/{{product.originalPrice}}</text>
			</view>
			<view class="institution">
				<text>慈善接收: 中国社会福利基金会</text>
				<text>执行机构: 中国社会福利基金会缘梦基金</text>
			</view>
		</view>
		...
		<view class="progress">
			...
			<view class="cont">
				<view class="li">
					...
					<view class="text">
						“让我们一起画曼陀罗，放松减压是曼陀罗艺术最基本的一个作用，跟语言文字相比，绘画更少地受到文化信念系统的影响，可以直达内心。”在8月份的关爱困境儿童项目实施中，中心链接心理师资源带领街道各村（社区）的困境儿童和留守儿童开启了一段奇妙的心灵之旅。《丰子恺散文》《城南旧事》《古文观止》《艾青诗选》......一本本由志愿者提前准备的书籍承载着温暖和希望，大家一起参与了长达2小时的阅读马拉松。玩转阅读笔记、写下青春故事等环节精彩丰富，教室里阅读氛围浓厚。
					</view>
				</view>
				<view class="li">
					<view class="h1">项目提额公示</view>
